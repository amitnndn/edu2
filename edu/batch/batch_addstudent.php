...
<form action="batch_addstudentconfirm.php?id=<?php echo $_GET['id']?>" method="post" style="margin-left: 25px; margin-right: 25px;">
<fieldset>

<?php 
	include_once('../database.php');
	$id = $_GET['id'];
	$sql1 = mysql_query("select * from batch where id=$id;");
	while($info1 = mysql_fetch_array($sql1))	{
		$name = $info1['batch_name'];
	}
?>
<legend>
Add students to <?php echo $name;?> batch
</legend>
<table>
