...
<form name="foo" action="facilitators_add.php" method="post" style="margin-left: 25px; margin-right: 25px;">
<fieldset>
<legend>
Add a Facilitator
</legend>
...
<tr><td>Contact Number:&nbsp</td><td><input type='text' name='contact'></td></tr>
